...
TOOLS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "when presenting them. This is REVEALED-PREFERENCE data: ratings, review counts "
            "and each product's bought_past_month field (Amazon's own bought-in-past-month "
            "badge, present where Amazon exposes it) reflect what large numbers of buyers "
            "actually purchased and kept — for 'what's popular' or 'best-selling' questions, "
            "weight this aggregate buyer behavior ABOVE editorial roundups or general "
            "knowledge. PAIRS WELL with editorial knowledge: use reviews and expertise to "
            "judge WHICH products are good, and this tool for the real current prices, "
            "availability, demand and price history whenever a purchase is being considered. "
            "MARKETPLACES us, uk, de, ca, au, walmart. COST free lane 1 of 30 daily queries "
