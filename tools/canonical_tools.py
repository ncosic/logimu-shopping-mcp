        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "country": {
                    ...
                    "default": "us",
                    "description": (
                        "Marketplace to look the product up in. Amazon: us, uk, de, ca, au, fr, it, es, jp, mx, br. "
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "category": {
                    "type": "string",
                    "description": (
                        "Restrict to a single product category. REFINEMENT ONLY - cannot "
                        "be used on its own; pair it with q or brand, which are the only "
                        "anchors. To browse a category with no keyword, use the shopping "
                        "tool instead."
                    ),
                },
                "marketplace": {
